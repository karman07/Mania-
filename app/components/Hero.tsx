...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-cream dark:bg-[#0A0A0A] pt-20">
      ...
      <div className="absolute -top-32 -right-32 w-[600px] h-[600px] rounded-full bg-saffron/10 dark:bg-saffron/8 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -left-20 w-[400px] h-[400px] rounded-full bg-saffron/8 dark:bg-saffron/5 blur-3xl pointer-events-none" />
      ...
      <div className="absolute top-48 left-[8%] w-8 h-8 bg-saffron/25 dark:bg-saffron/15 rounded-full animate-float-slow" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 items-center min-h-[calc(100vh-5rem)]">
          ...
          <div className="relative flex items-end justify-center lg:justify-end h-[480px] sm:h-[560px] lg:h-full">
            ...
            <div className="absolute bottom-0 right-0 w-80 h-80 sm:w-[420px] sm:h-[420px] rounded-full bg-gradient-to-br from-saffron/20 via-saffron/8 to-transparent dark:from-saffron/12 dark:via-saffron/5 dark:to-transparent blur-xl pointer-events-none" />
            ...
            {/* Floating chips */}
            <div className="absolute top-12 right-8 sm:right-16 bg-cream dark:bg-[#1A1A1A] manga-border rounded-lg px-3 py-2 animate-float-slow text-xs font-semibold text-ink dark:text-cream shadow-lg flex items-center gap-1.5">
            ...
            <div className="absolute bottom-24 right-4 sm:right-8 bg-parchment dark:bg-[#1E1E1E] manga-border rounded-lg px-3 py-2 animate-float-fast text-xs font-semibold text-ink dark:text-cream shadow-lg flex items-center gap-1.5" style={{ animationDelay: "0.5s" }}>
